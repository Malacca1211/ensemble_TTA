...
_C.CORRUPTION.TYPE = ['gaussian_noise']
...
def load_cfg_fom_args(args,description="Config options."):
    ...
    # log_dest = log_dest.replace('.yaml', '_local_{}.txt'.format(current_time))
    log_dest =  f'{cfg.MODEL.ADAPTATION}_{cfg.OPTIM.METHOD}_{cfg.OPTIM.LR}_bs{cfg.TEST.BATCH_SIZE}_em{cfg.RESET_CONSTANT_EM}.txt' #log_dest.replace('.yaml', f'{cfg.MODEL.ADAPTATION }_{cfg.OPTIM.METHOD}_{cfg.OPTIM.LR}_bs{cfg.TEST.BATCH_SIZE}_group.txt')
